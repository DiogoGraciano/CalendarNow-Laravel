    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                toggleText: t('auth.twoFactor.loginWithAuthCode'),
            };
        }

        return {
            title: t('auth.twoFactor.authenticationCode'),
            description: t('auth.twoFactor.authenticationCodeDescription'),
            toggleText: t('auth.twoFactor.loginWithRecoveryCode'),
        };
    }, [showRecoveryInput, t]);
