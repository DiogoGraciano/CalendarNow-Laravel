...
return [
    ...
    */
    ...
    'scheduling' => [
        'duration_exceeds_period' => 'La duración total de los servicios (:duration min) no puede superar el período seleccionado (:period min).',
        'employee_slot_overlap' => 'Ya existe una cita para este empleado en el período seleccionado.',
        'end_time_exceeds_services_duration' => 'La hora de fin no puede ser posterior al inicio más la duración total de los servicios (:duration min).',
        'default_dre_required' => 'Configure la cuenta DRE predeterminada para citas (cuenta a cobrar) en Configuración.',
        'default_dre_invalid' => 'La cuenta DRE predeterminada configurada no es válida. Actualícela en Configuración.',
    ],
