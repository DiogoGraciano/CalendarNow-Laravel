...
return [
    ...
    */
    ...
    'scheduling' => [
        'duration_exceeds_period' => 'A duração total dos serviços (:duration min) não pode ser maior que o período selecionado (:period min).',
        'employee_slot_overlap' => 'Já existe um agendamento para este funcionário no período selecionado.',
        'end_time_exceeds_services_duration' => 'O horário de término não pode ser posterior ao início mais a duração total dos serviços (:duration min).',
        'default_dre_required' => 'Configure a conta DRE padrão para agendamentos (conta a receber) em Configurações.',
        'default_dre_invalid' => 'A conta DRE padrão configurada não é válida. Atualize em Configurações.',
    ],
